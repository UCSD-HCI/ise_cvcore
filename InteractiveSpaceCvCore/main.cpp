...
int main()
{
	...
	debugFrame.header.width = settings.depthWidth;
	debugFrame.header.height = settings.depthHeight;
	debugFrame.header.isDataOwner = 1;
	debugFrame.header.dataBytes = settings.depthWidth * settings.depthHeight * 3;
